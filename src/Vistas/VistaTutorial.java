 ...
 * @author Celia
 */
public class VistaTutorial extends JPanel implements Observer {
    private JLabel imagen, titulo, imagen2, texto, label;
    private Font letra = new Font("Tahome", Font.BOLD, 16);;
    private MenuTutorial controlador;
    private ModeloAjustes modeloAjustes;

    public VistaTutorial(MenuTutorial controlador, ModeloAjustes modeloAjustes){
        setLayout(null);
    ...
    public void anadirImagen() {
     ...
     public void aniadirEtiquetas(){
            texto = new JLabel(modeloAjustes.getTexto()[23]);
