...
public class Freno extends Premio{
	...
	public Freno(int posx, int posy){
		...
		//setFondo(new ImageIcon(this.getClass().getResource("/imagenes/frenar.png")).getImage());
                redimensionarImagen();
        }
        
         public void redimensionarImagen() {
            // Cargar la imagen original
            Image imagenOriginal = new ImageIcon(this.getClass().getResource("/imagenes/frenar.png")).getImage();
