...
public class Acelerador extends Premio{
	...
	public Acelerador(int posx, int posy){
		...
		//setFondo(new ImageIcon(this.getClass().getResource("/imagenes/acelerar.png")).getImage());
                redimensionarImagen();
        }
         public void redimensionarImagen() {
            // Cargar la imagen original
            Image imagenOriginal = new ImageIcon(this.getClass().getResource("/imagenes/acelerar.png")).getImage();
